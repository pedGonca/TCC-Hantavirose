...
\begin{table}[h!]
\centering
\caption{Estimativas das variáveis significativas para o tempo de falha do modelo final.}
\begin{tabular}{lcccccccc}
  \hline
 & Parâmetro & Categoria & Coeficiente \\ 
  \hline
